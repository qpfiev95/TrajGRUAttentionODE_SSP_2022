import sys
sys.path.insert(0, '..')
from model_components.traj_gru import TrajGRU_EN, TrajGRU_DE
...
# in_channel, out_channel, kernel_size, stride, padding
    ...
    [
        TrajGRU_EN(input_channel=64, num_filter=64, b_h_w=(batch_size, init_size, init_size), zoneout=0.0,
        ...
        TrajGRU_EN(input_channel=96, num_filter=96, b_h_w=(batch_size, init_size//2, init_size//2), zoneout=0.0,
                i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                h2h_kernel=(3, 3), h2h_stride=(1, 1), h2h_pad=(1, 1), h2h_dilate=(1, 1), L=9,
                act_type=cfg.MODEL.RNN_ACT_TYPE,
                first_layer=False, last_layer=False, self_attention=False, ode_flag=False, zz_connection=False),

        TrajGRU_EN(input_channel=128, num_filter=128, b_h_w=(batch_size, init_size//4, init_size//4), zoneout=0.0,
                i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                h2h_kernel=(3, 3), h2h_stride=(1, 1), h2h_pad=(1, 1), h2h_dilate=(1, 1), L=9,
                act_type=cfg.MODEL.RNN_ACT_TYPE,
...
decoder_params = [
    ...
    [
        TrajGRU_DE(input_channel=128, num_filter=128, b_h_w=(batch_size, init_size//4, init_size//4), zoneout=0.0,
                i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                h2h_kernel=(3, 3), h2h_stride=(1, 1), h2h_pad=(1, 1), h2h_dilate=(1, 1), L=9,
                act_type=cfg.MODEL.RNN_ACT_TYPE,
                first_layer=True, last_layer=False, attention=False, ode_flag=False, zz_connection=False),

        TrajGRU_DE(input_channel=96, num_filter=96, b_h_w=(batch_size, init_size//2, init_size//2), zoneout=0.0,
                i2h_kernel=(3,3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                h2h_kernel=(3,3), h2h_stride=(1, 1), h2h_pad=(1, 1), h2h_dilate=(1, 1), L=9,
                act_type=cfg.MODEL.RNN_ACT_TYPE,
                first_layer=False, last_layer=False, attention=False, ode_flag=False, zz_connection=False),

        TrajGRU_DE(input_channel=64, num_filter=64, b_h_w=(batch_size, init_size, init_size), zoneout=0.0,
                i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                h2h_kernel=(3, 3), h2h_stride=(1, 1), h2h_pad=(1, 1), h2h_dilate=(1, 1), L=9,
                act_type=cfg.MODEL.RNN_ACT_TYPE,
