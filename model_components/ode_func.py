...
class DiffeqSolver(nn.Module):
    ...
    def forward(self, time_steps_to_predict, first_point, backwards=False):
        """
		# Decode the trajectory through ODE Solver
		"""
        pred_y = odeint(self.ode_func, first_point, time_steps_to_predict,
                        rtol=self.odeint_rtol, atol=self.odeint_atol, method=self.ode_method).to(torch.device("cuda"))
